              ...
              <ListGroup.Item key={item.productId}>
                <Row className="cart-item-row">
                  ...
                  <Col md={7} className="cart-item-details">
                    ...
                    <div className='rpoduct-quantity'>
                      Quantity:
                  ...
                  <Col md={2} className="remove-cart-item">
        ...
        <Card>
          <ListGroup variant="flush">
            <ListGroup.Item>
              ...
              <span className='sub-total'>₹ {cartItems.reduce((acc, item) => acc + item.qty * item.price, 0).toFixed(2)}</span>
            </ListGroup.Item>
            <ListGroup.Item>
              <Button
                type="button"
